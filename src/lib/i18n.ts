...
const es = {
  ...
  install: {
    ...
    bat: "Instalador (.bat)",
    ps1: "PowerShell (.ps1)",
    watchCopy: "Un solo archivo. Doble clic. Si en Descargas hay un watch-harbor-live.ps1 viejo, el .bat lo renombra a .old y no lo usa. Dejá la ventana abierta y Ctrl+F5 en Anno (o el autoguardado).",
