...
const es = {
  ...
  install: {
    ...
    check4: "Volver acá → Partida en vivo → soltar harbor-live.json (Documentos\\Anno 1800\\harbor-live.json)",
  ...
  connect: {
    ...
    s5: "El mod escribe Documentos\\Anno 1800\\harbor-live.json. Acá: Partida en vivo → soltá ese archivo. Harbor Buddy salta solo.",
...
const en: UiDict = {
  ...
  install: {
    ...
    check4: "Back here → Live session → drop harbor-live.json (Documents\\Anno 1800\\harbor-live.json)",
  ...
  connect: {
    ...
    s5: "The mod writes Documents\\Anno 1800\\harbor-live.json. Here: Live session → drop that file. Harbor Buddy jumps on its own.",
...
const it: UiDict = {
  ...
  install: {
    ...
    check4: "Torna qui → Partita in diretta → lascia harbor-live.json (Documenti\\Anno 1800\\harbor-live.json)",
  ...
  connect: {
    ...
    s5: "La mod scrive Documenti\\Anno 1800\\harbor-live.json. Qui: Partita in diretta → trascina quel file. Harbor Buddy salta da solo.",
...
const de: UiDict = {
  ...
  install: {
    ...
    check4: "Zurück hier → Live-Partie → harbor-live.json ablegen (Dokumente\\Anno 1800\\harbor-live.json)",
  ...
  connect: {
    ...
    s5: "Die Mod schreibt Dokumente\\Anno 1800\\harbor-live.json. Hier: Live-Partie → Datei ablegen. Harbor Buddy springt selbst.",
