...
const es = {
  ...
  install: {
    ...
    bat: "Instalador (.bat)",
    ps1: "PowerShell (.ps1)",
    watchCopy: "El loader de Anno 1800 no dumppea misiones. Este script mira tu último guardado y escribe harbor-live.json. Dejá la ventana abierta. Guardá con F5.",
...
const en: UiDict = {
  ...
  install: {
    ...
    bat: "Installer (.bat)",
    ps1: "PowerShell (.ps1)",
    watchCopy: "Anno 1800's loader cannot dump quests. This script watches your latest save and writes harbor-live.json. Leave the window open. Save with F5.",
...
const it: UiDict = {
  ...
  install: {
    ...
    bat: "Installer (.bat)",
    ps1: "PowerShell (.ps1)",
    watchCopy: "Il loader di Anno 1800 non può dumpare le missioni. Questo script guarda il tuo ultimo salvataggio e scrive harbor-live.json. Lascia la finestra aperta. Salva con F5.",
    watchBat: "Watcher (.bat)",
...
const de: UiDict = {
  ...
  install: {
    ...
    bat: "Installer (.bat)",
    ps1: "PowerShell (.ps1)",
    watchCopy: "Der Anno-1800-Loader kann keine Quests dumpen. Dieses Skript liest deinen letzten Spielstand und schreibt harbor-live.json. Fenster offen lassen. Mit F5 speichern.",
    watchBat: "Watcher (.bat)",
