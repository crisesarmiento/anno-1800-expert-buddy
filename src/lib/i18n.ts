...
const es = {
  ...
  welcome: {
    ...
    journalNote: "Los títulos del diario quedan como en tu partida, para matchear la misión.",
  },
  live: {
    ...
    whyEmpty: "El mod de Anno no escribe el diario: el loader oficial no corre Lua. Corré el vigilante, guardá con F5 y soltá harbor-live.json.",
...
const en: UiDict = {
  ...
  welcome: {
    ...
    journalNote: "Journal titles stay as in your save, so the mission can match.",
  },
  live: {
    kicker: "Live session",
    title: "Drop the journal. I'll jump.",
    ...
    whyEmpty: "The Anno mod cannot write the journal: the official loader does not run Lua. Run the watcher, save with F5, and drop harbor-live.json.",
...
const it: UiDict = {
  ...
  welcome: {
    ...
    journalNote: "I titoli del diario restano come nella tua partita, così la missione può combaciare.",
  },
  live: {
    kicker: "Partita in diretta",
    title: "Lascia il diario. Salto io.",
    ...
    whyEmpty: "La mod di Anno non scrive il diario: il loader ufficiale non esegue Lua. Avvia il watcher, salva con F5 e trascina harbor-live.json.",
...
const de: UiDict = {
  ...
  welcome: {
    ...
    journalNote: "Tagebuchtitel bleiben wie in deinem Spiel, damit die Mission passt.",
  },
  live: {
    kicker: "Live-Partie",
    title: "Wirf das Tagebuch rein. Ich springe.",
    ...
    whyEmpty: "Die Anno-Mod schreibt kein Tagebuch: der offizielle Loader führt kein Lua aus. Watcher starten, mit F5 speichern, harbor-live.json ablegen.",
