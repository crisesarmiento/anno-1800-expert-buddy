...
export const missions: Mission[] = [
  ...
  },
  {
    ...
    why: "Este es el juego entero, en chiquito. En La Inapetente el pueblo puede estar limpio y igual irse al rojo: unos 60 granjeros no bancan una veintena de chimeneas. Madera, un mercado, unos 10×10. Primero llená casas; después destrabá un trabajo. Si esto te cierra, llegás al final de la historia.",
    do: [
      ...
      "Casas y laburo al mismo ritmo. No plantes más chimeneas que gente.",
      "Stockeá tablas antes de stampiar un plano. Tres cadenas de madera son para la ola de blueprints, no para siempre; en calma, pausá los extra.",
    ],
    dont: "No te armes la capital soñada. Diez casas. Y pará, que se muden. Si el barrio no respira — casas llenas, necesidades en verde, ticker que no se hunde — no subas de clase.",
  ...
  },
  {
    ...
    why: "Cincuenta granjeros desbloquean el pescado. No estás rediseñando la ciudad — estás alimentando la que tenés, y después plantás unas casas más. Unos 60 granjeros no bancan una veintena de edificios de producción.",
    do: [
      ...
      "Una estación de bomberos al centro del barrio de granjeros. Si ves tres techos rojos en zzz, pausá o tiralas las demás.",
    ],
    ...
    suggestedAsks: [
      ...
      "¿Por qué tengo instituciones en zzz?",
    ],
  },
  {
    id: "ch1-ditchwater",
    ...
    dont: "No tires un segundo mercado solo porque limpiaste una ruina con forma de mercado. Explorar no es asentar: scoutear islas ≠ colonizarlas.",
    ...
    suggestedAsks: ["¿Pongo otro mercado?", "¿Fundó otra isla?"],
  },
  {
    id: "ch1-earth",
    chapterId: "ch1",
    ...
    why: "Madera gratis. Siempre agarrá la madera gratis. La madera es para construir ahora; si el almacén está lleno y no hay plano, esas chimeneas solo restan.",
    do: [
      "Limpiá la ruina chica marcada.",
      "Dejá que los tablones lleguen al almacén.",
      "Si estabas trabado con las casas, seguí plantando.",
      "Tres cadenas de madera se justifican cuando llegan blueprints: stockeá tablas ANTES de stampiar. En calma, pausá los extra.",
    ],
    ...
    suggestedAsks: ["Sigo sin madera suficiente", "¿Por qué tres aserraderos?", "¿Stampio el plano ahora?"],
  },
  {
    id: "ch1-toast",
    chapterId: "ch1",
    ...
    dont: "No subas a nadie a obrero. Los granjeros bancan toda esta receta. Si el barrio no respira — casas llenas, necesidades en verde — no subas de clase.",
  ...
  },
  {
    ...
    do: [
      ...
      "Si llega un plano, stockeá tablas ANTES de stampiar. No dejes tres aserraderos corriendo ‘por las dudas’.",
    ],
    ...
    suggestedAsks: ["¿Por qué el almacén está vacío si tengo destilería?", "¿Stampio el plano ahora?"],
  ...
  },
  {
    ...
    dont: "No copies su plano. Su ciudad es escenografía. Tampoco plantes más estaciones de bomberos ‘por las dudas’.",
    trap: "Buscarlos en el mar. Están en tierra, en sus calles.",
    overwhelmed: "Cinco grupos para tocar. Y te volvés a tus 10×10.",
    buildingIds: [],
    suggestedAsks: [
      "No encuentro a los revoltosos",
      "¿Cuántas estaciones de bomberos?",
      "¿Por qué tengo instituciones en zzz?",
  ...
  },
  {
    ...
    why: "Dos toques en un muelle. Después la historia te deja quieto a propósito. Si el saldo está en rojo, usá la espera para recortar gasto, no para plantar más.",
    do: ["Seleccioná al editor.", "Seleccioná su barco.", "Dejá que entre la próxima misión."],
    dont: "No arranques una cadena de periódico. Todavía no hay. Tampoco sigas construyendo si el ticker está en rojo.",
    ...
    buildingIds: [],
    suggestedAsks: [
      "¿Qué construyo mientras espero?",
      "El saldo está en rojo, ¿qué hago?",
      "¿Sigo construyendo igual?",
    ],
  },
  {
    id: "ch1-debt",
    ...
    why: "Una pausa a propósito. Usala para ordenar: más madera, más casas, más Schnapps. Nada de sistemas nuevos. Si el saldo está en rojo, no es pánico: es disciplina de caja.",
    do: [
      "Mantené en verde madera, pescado, ropa y Schnapps.",
      "Plantá otro 10×10 si te pinta — y el ticker no está en rojo.",
      "Cuando llame Edvard, agarrá la misión — esa licencia es la que abre obreros.",
      "Si estás en rojo: pará de construir, pausá lo que duerme, llená casas, vendé el sobrante. El verde vuelve cuando baja el gasto, no cuando plantás más.",
    ],
    dont: "No fundes tres islas nuevas de puro aburrimiento. Scoutear ≠ colonizar. Primero el pueblo de La Inapetente.",
  ...
  },
  {
    ...
    why: "Navegá, tocá el pecio, volvé. Pausá el cerebro de construir ciudad. Mandá el barco a mirar y a cumplir mandados — fundar otra colonia ahora es un segundo ticker.",
    do: ["Llevá un barco al marcador del naufragio.", "Levantá gente y restos.", "Volvé."],
    dont: "No armes una flota nueva para un recojo. Un solo barco no es flota de regalos ni de diplomacia: primero el pueblo de La Inapetente.",
    trap: "Dejar el barco en una ruta comercial. Agarrá el control un minuto.",
    overwhelmed: "Un barco, un naufragio, levantá las cosas.",
    buildingIds: [],
    suggestedAsks: ["¿Qué barco uso?", "¿Fundó otra isla?", "¿Sigo las misiones en barco?"],
  },
  {
    id: "ch1-business",
    chapterId: "ch1",
