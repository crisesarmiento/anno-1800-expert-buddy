...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-kAsQv_Tj.mjs");
...
var manifest = { "f345c695ab2916dd3456ae42ecfc6f01fcc27c17e5b4d82584ab007059211537": {
	functionName: "askBuddy_createServerFn_handler",
	importer: () => import("./buddy-zsrKepig.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CKknuEfW.mjs").then((n) => n.t),
